...
import { assert, clone, CLOSE_REASON_GROUP_NOT_FOUND, deserialize, newGroup, operations, serialize, CURRENT_VERSION, type Group, type Message, type Operation } from 'moneysplit-common';
...
export class WebSocketDriver implements Driver {
  ...
  startConnection() {
    ...
    url.searchParams.set('version', CURRENT_VERSION.toString());
